...
namespace MyHotelTuto
{
    public partial class Bookings : Form
    {
        ...
        {
            Con.Open();
            string Query = "select * from RoomTbl where RoomTbl.RStatus='Available'";
            //string Query = "select * from RoomTbl,HotelTbl where RoomTbl.RStatus='Available' and HotelTbl.HNum=RoomTbl.HNum and RoomTbl.HNum='" + HotelCb.SelectedIndex.ToString()+"'" ;
            SqlCommand cmd = new SqlCommand(Query, Con);
            SqlDataReader rdr;
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select RSsn from ReceptionistTbl", Con);
            SqlDataReader rdr;
            rdr = cmd.ExecuteReader();
            DataTable dt = new DataTable();
