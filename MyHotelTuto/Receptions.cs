...
namespace MyHotelTuto
{
    public partial class Receptions : Form
    {
        ...
        {
            if (RssnTb.Text==""||RnameTb.Text == "" || RphoneTb.Text == "" || HotelCb.SelectedIndex == -1 || GenderCb.SelectedIndex == -1)
            {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("update ReceptionistTbl set RSsn=@RS,RName=@RN,RPhone=@RP,RGender=@RG where RSsn = @RKey ", Con);
        ...
        private void InsertReceptionist()
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    SqlCommand cmd = new SqlCommand("insert into ReceptionistTbl(HNum,RSsn,RName,RPhone,RGender) values(@HN,@RS,@RN,@RP,@RG)", Con);
