...
namespace MyHotelTuto
{
    public partial class Dashboard : Form
    {
        ...
        {
            Con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("select count(RNum) from RoomTbl ",Con);
        ...
        {
            Con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("select sum(BCost) from BookingTbl", Con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
        ...
        {
            Con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("select count(RSsn) from ReceptionistTbl",Con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
        ...
        {
            Con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("select count(BookNum) from BookingTbl", Con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
